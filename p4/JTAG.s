...
PRINT_JTAG:
	...
	movia 	r17, TIEMPOacumulado 	/* direccion base del contador de intervalos del Timer */
	ldw   	  r4, 0(r17)
	...
	movia 	r17, ATASCO		/* direccion base del contador de intervalos del Timer */
	ldw   	r4, 0(r17)
	call  	BCD			/* r4= valor binario, r2= valor BCD */
...
*/
TEXTO:
.asciz 	"\n\nCiclos en atascos de CODEC= "
TEXTO2:
.asciz 	"\nNumero de iteraciones en atascos= "
TEXTO3:
.asciz 	"\nCiclos TOTALES del programa= "
TEXTO4:
.asciz 	"\nNumero bucles de atascos= "
